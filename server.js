...
- "APLICACAO CONTAMAX", "RESGATE CONTAMAX AUTOMATICO" e equivalentes (aplicação automática do próprio banco) são categoria=movimentacao_interna — é o banco guardando/devolvendo o saldo do dia, não é gasto nem receita.
...
Responda SOMENTE com um JSON array válido, sem markdown, sem texto antes/depois, cada item no formato exato:
{"data":"AAAA-MM-DD","descricao":"string curta com o nome completo se houver","valor":0.00,"tipo":"entrada|saida","categoria":"uma das da lista acima","naturezaFiscal":"só se a tabela de referência tiver essa informação pro nome, senão string vazia","provavelmentePessoal":false,"confianca":"alta|media|baixa","observacao":""}`;
