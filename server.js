...
app.post('/api/extrato/analisar', async (req, res) => {
  try {
    ...
    const instrucoes = `Você está lendo um extrato bancário semanal (PagBank) de uma fábrica de colchões (Orto Premium), pra separar despesas pequenas do dia a dia por categoria, já que hoje isso é feito só no fim do mês, tudo misturado.
